...
$speciality = [
    [
        ...
        'period1' => январь 2015,
        'period2' => 2020,
        'about' => 'разрабатывал все что можно',
    ],
    [
        'name' => 'дизайнер',
        'period1' => 2013,
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            <?php for($i = 0; $i < count($speciality); $i++): ?>  
                    <div class="w3-container">
                    <h5 class="w3-opacity"><b><?php echo $speciality[$i]['name'] ?></b></h5>
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $speciality[$i]['period1'] ?> <span
                        class="w3-tag w3-teal w3-round"><?php echo $speciality[$i]['period2'] ?></span></h6>
                    <p><?php echo $speciality[$i]['about'] ?></p>
                    <?php endfor; ?>
            <hr>
